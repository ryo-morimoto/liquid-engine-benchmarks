...
### ベンチマーク実装（素材準備 + 開発環境 完了後）

- [ ] [PHP ベンチマーク](docs/plans/benchmarks.ja.md#php-ベンチマーク) - php/
- [ ] [Ruby ベンチマーク](docs/plans/benchmarks.ja.md#ruby-ベンチマーク) - ruby/

### 実行基盤（ベンチマーク実装 完了後）

- [ ] [実行スクリプト](docs/plans/execution.ja.md#実行スクリプト) - scripts/*.sh
- [ ] [結果出力](docs/plans/execution.ja.md#結果出力) - results/, generate-table.sh
